...
if (d2[1]=false) and (d2[3]=false) and  (d2[4]=false) and (d2[5]=false) and (d2[6]=false) and (d2[7]=false) and (d2[8]=false) then begin form3.hide; form2.show; timer1.enabled:=true; end;
